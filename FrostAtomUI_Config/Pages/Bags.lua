...
ns.RegisterPage({
	...
	schema = {
		...
		},
		{
			...
			values = {
				{ "ALT", L["Alt + click"] },
				{ "ALT-CTRL", L["Alt + Ctrl + click"] },
				{ "ALT-SHIFT", L["Alt + Shift + click"] },
				{ "CTRL-SHIFT", L["Ctrl + Shift + click"] },
			},
			desc = L["Locks a bag slot, filled or empty: sorting and stacking leave it alone. Click again to unlock."],
		},
		{
			type = "execute",
			new = "1.4.1",
