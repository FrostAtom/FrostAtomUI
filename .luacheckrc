...
read_globals = {
	...
	"MultiCastFlyoutFrame", "MultiCastFlyoutFrameCloseButton", "MultiCastSummonSpellButton", "MultiCastRecallSpellButton",
	"NUM_MULTI_CAST_PAGES", "NUM_MULTI_CAST_BUTTONS_PER_PAGE",
	...
	"MAX_BOSS_FRAMES", "MAX_PLAYER_LEVEL", "FACTION_BAR_COLORS", "CLOSE", "MAX_TOTEMS", "TOTEM_PRIORITIES",
